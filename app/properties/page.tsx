        ...
        <Box
          ...
          <Chip
            ...
            sx={{
              ...
              fontSize: "0.75rem",
              backgroundColor:
                statusTag?.toLowerCase() === "available"
                  ? "#3498db"
                  : statusTag?.toLowerCase() === "sold"
                  ? "#e74c3c"
                  : statusTag?.toLowerCase() === "pending"
                  ? "#f39c12"
                  : "#bdc3c7",
              color: "#fff",
        ...
        <Box sx={{ mb: 2 }}>
          ...
          {initialPaymentAmount && (
            <Typography
              ...
              {category === "rent" ? "التأمين: " : "المقدم: "}
              {formatPrice(initialPaymentAmount)} جنيه
            </Typography>
          )}
        </Box>
